...
/// <summary> generic object class </summary>
class Objs<T> : IEnumerable<T>
{

    List<T> roomObjects = new List<T>();

    ///<summary> add to our generiic list </summary>
    public void Add(T item)
    {
        roomObjects.Add(item);
    }

    /// <summary> get the room objects enumerable </summary>
    public IEnumerator<T> GetEnumerator()
    {
        return (roomObjects.GetEnumerator());
    }

    /// <summary> not actually implementing it </summary>
